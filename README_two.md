...
# Debug Controller Extension

A VS Code extension that listens to JavaScript debugger events and provides programmatic control over the debugging process.

## Quick Start

1. Create folder: `mkdir debug-controller && cd debug-controller`
2. Copy the files below into the folder
3. Run: `npm install`
4. Open folder in VS Code and press `F5` to test
